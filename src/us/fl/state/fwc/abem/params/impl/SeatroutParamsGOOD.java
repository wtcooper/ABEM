...
public class SeatroutParamsGOOD extends AbstractParams {
	...
	public int popnAbundance= 100000; 			//6260925;  
	private int schoolSize=1;							//smallest school after which will merge 

	//Spawning variables
	private double startOfBreeding= 32; //59 is 1st day in Sue's data 
	...
	@Override
	public synchronized double getNatInstMort(int yearClass, double size, int sex) {
	...
	public synchronized double[] getSizeFreqArray(int year, int sex) {
		...
		if (sizeFreqByYear == null) {
			...
			sizeFreqByYear.put(	19700	, new double[][] { {	0.607195692,0.262276848,0.108087619,0.019881257,0.002136239,0.000320617,7.18194E-05,2.33418E-05,5.0852E-06,1.12024E-06,2.49136E-07,5.58535E-08,5.58535E-08	}, {	0.515439445,0.259438756,0.149391269,0.063294982,0.010883994,0.001308513,0.000195825,3.37287E-05,9.54361E-06,2.71791E-06,7.7849E-07,2.24117E-07,2.24117E-07	} }); //average of 1967-1970
			sizeFreqByYear.put(	19850	, new double[][] { {	0.552423208,0.253378273,0.127191541,0.045994501,0.013718437,0.004489489,0.001702578,0.000688666,0.00025599,9.52874E-05,3.5517E-05,1.32561E-05,1.32561E-05	}, {	0.51447879,0.243005281,0.13517112,0.068316138,0.027245559,0.008161075,0.00249021,0.000649959,0.000274082,0.00011611,4.94168E-05,2.11299E-05,2.11299E-05	} });
			sizeFreqByYear.put(	20090	, new double[][] { {	0.442678632,0.212073352,0.119632389,0.078392924,0.050732195,0.032207181,0.021111346,0.01747108,0.010604481,0.006438043,0.003909428,0.002374474,0.002374474	}, {	0.423703621,0.215338688,0.115736534,0.074902715,0.049951365,0.036420246,0.024543007,0.022818744,0.014410261,0.009109257,0.00576398,0.00365079,0.00365079	} }); //average of 2006-2009
	...
	public synchronized int getPopulationAbundance(int year, int sex) {
		...
		if (fishAbundByYear == null) {
			...
			fishAbundByYear.put(	19850	, new int[] {	5831998	,	9267344	});
