...
public class RedfishParams extends AbstractParams {
	...
	private int ageMax=50; 								//TODO Max age in years
	private double sizeAtMaturityAvg=26.8002; 	//TODO 
	private double sizeAtMaturitySD=2.196391585;	//TODO
	...
	private double[]  c= {2.4599,2.4599};  									//TODO c parameter defines the shape of the weight as function of age relationship: c <=1 is saturating; c>1 is sigmoidal
	private double[]  K= {3.7612,3.7612};  									//TODO K is constant which defines the growth rate, where increasing K is faster growth rate;  here, K is in per year units, calculated from vonBertalanffy length curve
	...
	private double[] maxMass={11.77916, 11.77916}; 					//TODO Maximum mass per individuals for this species
...
/*	private boolean haveSpawnAggregations=true;	//If agent has known spawning aggregations
	protected ArrayList<Coordinate> spawnAggregationList = new ArrayList<Coordinate>();  // waypoint list of known spawn aggregations
	private double spawnAggregationSpecificity = .7; //TODO The probability that any given individual will move towards a specific aggregation, versus spawn in other suitable habitat
	private int peakLunarSpawnTime=0;					//TODO The peak lunar spawning time if they are synchronized; here, 0=new, 15=full; see TimeUtils.getMoonPhase()
	private double lunarSpecificity=1; 						//TODO The specificity from 0-1 if an agent is synchronized to spawn on moon phase; 1=only spawn on the peakLunarSpawnTime; 0=spawn anytime
	private boolean isMultipleSpawner=true; 			//TODO If an agent spawns multiple times in a single breeding season
	...
	private double ageMax=50; 								//TODO Max age in years
	private double ageMaturity=1; 							//TODO Age of maturity in years
	// growth parameters
	private double c=2.4599; 									//TODO c parameter defines the shape of the weight as function of age relationship: c <=1 is saturating; c>1 is sigmoidal
	private double K=3.7612; 									//TODO K is constant which defines the growth rate, where increasing K is faster growth rate;  here, K is in per year units, calculated from vonBertalanffy length curve
	private double iniMass=0.001; 							//TODO Initial mass, i.e. mass of an egg 
	private double maxMass=11.77916; 					//TODO Maximum mass per individuals for this species
	private int massCatchUpRate=6; 						//TODO Rate at which true mass will catch up to nominal mass, e.g., if a fish is starved and has now found steady food, or after a reproduction event
	// mortality parameters
	private double baseMortality=0.62; 					//TODO Base mortality rate, M/year
	...
	*/
	...
	public void initialize(Scheduler sched){
		...
		dependentsTypeList.add("Redfish"); 
		dependentsTypeList.add("RecFisherman"); 
		interactionTicks.put("Redfish", 5l); 
