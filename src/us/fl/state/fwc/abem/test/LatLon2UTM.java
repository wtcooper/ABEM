...
/**Class for Converting between WGS84 and UTM coordinates (i.e., lat-lon to meters northing/easting)
...
public class LatLon2UTM {
	 ...
	 */
	public double[] LatLonToUTMXY (double lat, double lon, double zone)
	{
	 ...
	 */
	public double[] UTMXYToLatLon (double x,double  y, double zone, boolean southhemi)
	{
