 ...
 *
 */
public class SimpleXYBarChart extends ApplicationFrame {
     ...
     */
    public SimpleXYBarChart (final String title) {
        super(title);
    ...
    public static void main(final String[] args) {
        ...
        final SimpleXYBarChart  demo = new SimpleXYBarChart ("XY Series Demo 3");
        demo.pack();
