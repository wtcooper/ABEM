 ...
 *
 */
public class SimpleXYScatterPlot extends ApplicationFrame {
     ...
     */
    public SimpleXYScatterPlot(final String title) {
...
//        chart.setLegend(null);
  ...
  //      panel.setHorizontalZoom(true);
    //    panel.setVerticalZoom(true);
        ...
        try {
			exp.exportChartAsSVG(chart, new Rectangle2D.Double(100, 100, 500, 400) , new File("sampleScatterChart.svg"));
		} catch (IOException e) {
    ...
    public static void main(final String[] args) {
        ...
        final SimpleXYScatterPlot demo = new SimpleXYScatterPlot("Fast Scatter Plot Demo");
        demo.pack();
