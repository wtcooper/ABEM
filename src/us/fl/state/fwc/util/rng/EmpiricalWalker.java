...
/**
 * Returns a random integer <tt>k</tt> with probability <tt>pdf(k)</tt>, given a 
 * uniformly distributed random variate <tt>u</tt> from 0.0 to 1.0
 */
public int nextInt(double u) {
	int c=0;
	double f;
//#if KNUTH_CONVENTION
//    c = (int)(u*(g->K));
