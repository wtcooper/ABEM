 ...
 * @source $URL$
 */
public class JMapFrameEmpty extends JFrame {
    ...
    public static void showMap(MapContext context) {
        final JMapFrameEmpty frame = new JMapFrameEmpty(context);
     ...
     */
    public JMapFrameEmpty(MapContext context) {
     ...
     */
    public JMapFrameEmpty(MapContext context, GTRenderer renderer) {
    ...
    public void addMapPane(JMapPane pane){
    	this.mapPane = pane; 
    	if (mapPane.getBackground()==null) mapPane.setBackground(Color.white); 
    	if (mapPane.getMapContext() == null) mapPane.setMapContext(context);
    	if (mapPane.getRenderer() == null) mapPane.setRenderer(new StreamingRenderer());
    }
     ...
     * calling {@linkplain #enableTool} with all {@linkplain JMapFrameEmpty.Tool}
     * constants.
     * 
     ...
     * by {@linkplain JMapFrameEmpty.Tool} constants.
     * <code><pre>
     * myMapFrame.enableTool(Tool.PAN, Tool.ZOOM);
     * </pre></code>
     *
     * @param tool one or more {@linkplain JMapFrameEmpty.Tool} constants
     */
