...
public class SingleParticleMapper extends JMapPane {
	...
	protected void paintComponent(Graphics g) {
		...
		System.out.println("done with paintComponent()"); 
	}
	...
	public void onRenderingCompleted() {
		...
		System.out.println("done with onRenderingCompleted()"); 
	}
...
*/
	...
	private void paintSprite(Graphics2D gr2D) {
		...
		try { Thread.currentThread().sleep((long) (200)); } catch (InterruptedException e) { e.printStackTrace(); }
	}
